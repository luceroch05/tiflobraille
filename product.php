...
// Obtener todos los productos de la categoría 'educativo' (puedes cambiarla)
    ...
    <div class="container">
      ...
      <div class="product-gallery">
       <?php foreach ($productos as $producto): ?>
        <div class="product-item <?= htmlspecialchars($producto['categoria_slug']) ?>" data-id="<?= htmlspecialchars($producto['slug']) ?>">
            <div class="product-thumb">
              <a href="/tiflobraille/producto/<?= htmlspecialchars($producto['categoria_slug']) ?>/<?= htmlspecialchars($producto['slug']) ?>"">
